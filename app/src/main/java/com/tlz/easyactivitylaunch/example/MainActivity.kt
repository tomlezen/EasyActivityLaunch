...
@EasyLaunchForResult(parameters = [Int::class, Array<MainActivity.TestClass>::class], fragmentSupport = true)
@EasyLaunch1(nickName = "CustomFuncName", parameters = [Intent::class, Bundle::class])
@EasyLaunch2(parameters = [IntArray::class, Double::class], fragmentSupport = true)
